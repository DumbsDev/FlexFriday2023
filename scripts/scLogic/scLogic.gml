...
function dailyPopChange(){
	...
	if global.food < global.population and global.food > global.population/4{ // reduce joy when people are hungry
		print("Lost Only Joy From Lack Of Food")
	...
	} else if global.food < global.population / 4 { // reduce population and joy when people are starving
		print("Lost Population and Joy From Lack Of Food")
		print("Food: " + string(global.food))
	...
	} else if global.food > global.population*1.25{ // increase joy if people have a bunch of food
	...
	} else if global.water < global.population / 2 { // reduce population and joy if there is a lot less water than population
		print("Lost Population And Joy From Large Lack of Water")
		print("Water: " + string(global.water))
		print("Pre-change Population: " + string(global.population))
	...
	} else if global.water > global.population * 1.5 { // increase joy if there is a ton of water
	...
	if global.joy > 125 and global.food > global.population and global.water > global.population{ // people get it on
